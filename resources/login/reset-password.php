...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Authentication - کلمه عبور reset -->
				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							...
							<!--begin::ثبت نام link-->
							<div class="m-0">
								<span class="text-gray-400 fw-bold fs-5 me-2" data-kt-translate="password-reset-head-desc">قبلا عضو شده است </span>
								<a href="../../demo1/dist/authentication/layouts/fancy/sign-in.html" class="link-primary fw-bold fs-5" data-kt-translate="password-reset-head-link">ورود</a>
							</div>
							<!--end::ثبت نام link=-->
						</div>
						<!--end::Header-->
						...
						<div class="py-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="../../demo1/dist/authentication/layouts/fancy/new-password.html" action="#">
								...
								<div class="text-start mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3 fs-3x" data-kt-translate="password-reset-title">فراموشی کلمه عبور </h1>
									<!--end::Title-->
									<!--begin::Text-->
									<div class="text-gray-400 fw-semibold fs-6" data-kt-translate="password-reset-desc">ایمیل تان را وارد کنید تا پسوردتان ریست شود.</div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								<div class="fv-row mb-10">
									<input class="form-control form-control-solid" type="email" placeholder="ایمیل" name="email" autocomplete="off" data-kt-translate="password-reset-input-email" />
								</div>
								<!--end::Input group-->
								<!--begin::Actions-->
								<div class="d-flex flex-stack">
									...
									<div class="m-0">
										...
										<a href="../../demo1/dist/authentication/layouts/fancy/sign-in.html" class="btn btn-lg btn-light-primary fw-bold" data-kt-translate="password-reset-cancel">بی خیال</a>
									</div>
									<!--end::Link-->
								</div>
								<!--end::Actions-->
			...
			<!--end::Authentication - کلمه عبور reset-->
		</div>
		<!--end::Root-->
		<!--begin::Javascript-->
