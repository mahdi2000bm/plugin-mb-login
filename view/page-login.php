...
<?php include "templates/header.php" ?>
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="#" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
                                            <img alt="Logo" src="<?= MB_PLUGIN_URL ?>/assets/media/svg/brand-logos/google-icon.svg" class="p-4" />
                                        </a>
                                        <!--end::Symbol-->
                                    </div>
                                    <!--end::Social-->
            ...
            <!--end::Aside-->
            <!--begin::Body-->
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background-image: url(<?= MB_PLUGIN_URL ?>assets/media/auth/bg.png)"></div>
            <!--begin::Body-->
        </div>
