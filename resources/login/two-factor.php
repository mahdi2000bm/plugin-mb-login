...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="py-20">
							<!--begin::Form-->
							<form class="form w-100 mb-10" novalidate="novalidate" data-kt-redirect-url="../../demo1/dist/index.html" id="kt_sing_in_two_factor_form">
								<!--begin::Icon-->
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3" data-kt-translate="two-step-title">تایید دو مرحله ای</h1>
									<!--end::Title-->
									<!--begin::Sub-title-->
									<div class="text-muted fw-semibold fs-5 mb-5" data-kt-translate="two-step-deck">کد تأییدی را که به آن فرستادیم وارد کنید</div>
									<!--end::Sub-title-->
									<!--begin::Mobile no-->
								...
								<div class="mb-10">
									<!--begin::Label-->
									<div class="fw-bold text-start text-dark fs-6 mb-1 ms-1" data-kt-translate="two-step-label">کد امنیتی 6 رقمی خود را تایپ کنید</div>
									<!--end::Label-->
									<!--begin::Input group-->
		...
		<script src="assets/js/custom/authentication/ورود/دو عاملی.js"></script>
