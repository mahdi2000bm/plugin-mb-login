...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							...
							<!--begin::ثبت نام link-->
							<div class="m-0">
								<span class="text-gray-400 fw-bold fs-5 me-2" data-kt-translate="ثبت نام-head-desc">قبلا عضو شده است </span>
								<a href="../../demo1/dist/authentication/layouts/fancy/sign-in.html" class="link-primary fw-bold fs-5" data-kt-translate="ثبت نام-head-link">ورود</a>
							</div>
							<!--end::ثبت نام link=-->
						</div>
						<!--end::Header-->
						...
						<div class="py-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="../../demo1/dist/authentication/layouts/fancy/sign-in.html" action="#">
								...
								<div class="text-start mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3 fs-3x" data-kt-translate="ثبت نام-title">یک حساب کاربری ایجاد کنید</h1>
									<!--end::Title-->
									<!--begin::Text-->
								...
								<div class="row fv-row mb-7">
									<!--begin::Col-->
									<div class="col-xl-6">
										<input class="form-control form-control-lg form-control-solid" type="text" placeholder="نام " name="first-name" autocomplete="off" data-kt-translate="ثبت نام-input-first-name" />
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-xl-6">
										<input class="form-control form-control-lg form-control-solid" type="text" placeholder="فامیل" name="last-name" autocomplete="off" data-kt-translate="ثبت نام-input-last-name" />
									</div>
									<!--end::Col-->
								</div>
								<!--end::Input group-->
								...
								<div class="fv-row mb-10">
									<input class="form-control form-control-lg form-control-solid" type="email" placeholder="ایمیل" name="email" autocomplete="off" data-kt-translate="ثبت نام-input-email" />
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-10" data-kt-password-meter="true">
									...
									<div class="mb-1">
										...
										<div class="position-relative mb-3">
											<input class="form-control form-control-lg form-control-solid" type="password" placeholder="کلمه عبور" name="password" autocomplete="off" data-kt-translate="ثبت نام-input-password" />
									...
									<!--end::Wrapper-->
									<!--begin::Hint-->
									<div class="text-muted" data-kt-translate="ثبت نام-hint">از 8 یا بیشتر کاراکتر با ترکیبی از حروف، اعداد و نمادها استفاده کنید.</div>
									<!--end::Hint-->
								</div>
								<!--end::Input group=-->
								<!--begin::Input group-->
								<div class="fv-row mb-10">
									<input class="form-control form-control-lg form-control-solid" type="password" placeholder="رمز عبور را تأیید کنید" name="confirm-password" autocomplete="off" data-kt-translate="ثبت نام-input-confirm-password" />
								</div>
								<!--end::Input group-->
								<!--begin::Actions-->
								<div class="d-flex flex-stack">
									<!--begin::ارسال-->
									<button id="kt_sign_up_submit" class="btn btn-primary" data-kt-translate="ثبت نام-submit">
		...
		<script src="assets/js/custom/authentication/ثبت نام/general.js"></script>
		<script src="assets/js/custom/authentication/ورود/i18n.js"></script>
